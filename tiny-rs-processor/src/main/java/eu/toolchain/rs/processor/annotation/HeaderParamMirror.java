...
@Data
public class HeaderParamMirror {
    private final AnnotationMirror annotation;
    private final String value;

    public static Result<HeaderParamMirror> getFor(final RsUtils utils, final Element element,
        ...
        return Result.ok(new HeaderParamMirror(a, value));
    }
}
