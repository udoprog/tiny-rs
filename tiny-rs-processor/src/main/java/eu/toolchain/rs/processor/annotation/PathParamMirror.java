...
@Data
public class PathParamMirror {
    private final AnnotationMirror annotation;
    private final String value;

    public static Result<PathParamMirror> getFor(final RsUtils utils, final Element element,
        ...
        return Result.ok(new PathParamMirror(a, value));
    }
}
